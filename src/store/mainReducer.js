...
export const shoppingItemsMap = (state: State) => state.shoppingList.shoppingItemsById;
export const getCurrentPathname = (state: State) => state.router.location.pathname;
